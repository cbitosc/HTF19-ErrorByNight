...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" action="studentphp.php">
      ...
      <button class="btn btn-lg btn-primary" type="submit" style="width:140px"><a href="studentphp.php" style="color:white;">Sign in</a></button>
